...
def getWeather():
    ...
    #weather
    api="https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=6aca5c2cc7147c22d20e26f3b3341339"
...
frame_mimage=Label(image=Frame_image)
frame_mimage.pack(padx=5,pady=5,side=BOTTOM)
